...
% Source: volume-i/propositional-logic/notes/notes-connectives.tex
% =========================================================
...
\begin{remark}[Return]
\hyperref[rmk:nand-non-associative]{$\leftarrow$ Back to Remark (Non-Associativity of NAND) in Notes}
\end{remark}

\begin{proposition}[Non-Associativity of NAND]
\label{prop:nand-non-associativity}
The NAND connective $\uparrow$ is not associative. That is,
\[
