...
% Consequence form
% ---------------------------------------------------------
\begin{corollary}\label{cor:consequence-compact}
...
unsatisfiable. By the compactness theorem, some finite subset
$\Gamma_0 \cup \{\neg\varphi\}$ is unsatisfiable. Hence $\Gamma_0 \models \varphi$.
\end{proof}
