...
\begin{proposition}[Every Formula Has an NNF]\label{prop:nnf-exists}
...
\begin{proposition}[Every Formula Has a CNF]\label{prop:cnf-exists}
...
\begin{proposition}[Every Formula Has a DNF]\label{prop:dnf-exists}
