...
all subsets of a universe $U$ remains valid when each operation and constant is
replaced by its dual: $\cup \leftrightarrow \cap$ and $\varnothing
\leftrightarrow U$ (with complements unchanged).
\end{corollary}
