...
\begin{proof}
For union: $x \in A \cup B \iff (x \in A \lor x \in B)
\iff (x \in B \lor x \in A) \iff x \in B \cup A$.
...
\begin{proof}
The first identity: $x \in A \cap (B \cup C) \iff (x \in A \land (x \in B \lor x \in C))
\iff ((x \in A \land x \in B) \lor (x \in A \land x \in C)) \iff x \in (A \cap B) \cup (A \cap C)$.
