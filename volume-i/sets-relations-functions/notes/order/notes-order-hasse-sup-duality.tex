...
\begin{proof}
The dual $(A, \geq)$ is itself a poset: $\geq$ is reflexive, antisymmetric,
and transitive because $\leq$ is. Any proof of $\Phi$ in an arbitrary
poset is therefore a proof of $\Phi^*$ in that same poset (reread with
the order reversed). The two directions are symmetric.
\end{proof}
