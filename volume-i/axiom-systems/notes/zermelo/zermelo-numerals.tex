...
\{a\} := \{a,a\},
\]
whose existence follows from the Pairing Axiom (Axiom~\ref{ax:pairing}).
\end{definition}
...
\begin{proposition}[First few Zermelo numerals]
...
\begin{proposition}[Distinctness of Zermelo numerals]
...
\begin{corollary}[No numeral contains itself]
