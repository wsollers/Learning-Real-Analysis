...
\begin{proposition}[Quantifier Negation Laws]\label{thm:qneg}
...
\begin{proposition}[Vacuous Quantification]\label{thm:vacuous}
...
\begin{proposition}[Renaming Bound Variables]\label{thm:rename}
