...
\subsubsection*{Strategy 1: Proving a Universal $\forall x\,\varphi(x)$}
...
\subsubsection*{Strategy 2: Proving an Existential $\exists x\,\varphi(x)$}
...
\subsubsection*{Strategy 3: Using a Universal $\forall x\,\varphi(x)$}
...
\subsubsection*{Strategy 4: Using an Existential $\exists x\,\varphi(x)$}
...
\subsubsection*{The Central Asymmetry: Universal vs.\ Existential Goals}
...
\subsubsection*{Nested Quantifiers: The $\forall\exists$ Pattern in Analysis}
