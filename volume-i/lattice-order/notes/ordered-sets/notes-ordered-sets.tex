...
\begin{remark*}[Dependencies]
No local dependencies.  The relationship with
\hyperref[def:partial-order]{partial orders} is established by the two
equivalences in the interpretation above.
\end{remark*}
