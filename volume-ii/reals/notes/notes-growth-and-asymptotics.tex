...
\begin{definition}[Ratio behavior]
...
\begin{definition}[Root behavior]
...
\begin{definition}[Asymptotic comparison]
Let $(a_n)$ and $(b_n)$ be sequences with $b_n \neq 0$ eventually.
...
\begin{definition}[Polynomial, exponential, and factorial growth]
A sequence exhibits:
