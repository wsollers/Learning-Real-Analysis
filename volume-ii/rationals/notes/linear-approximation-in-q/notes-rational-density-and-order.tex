...
\begin{remark*}[Standard quantified statement]
\[
\forall q\in\mathbb{Q}\;\forall \varepsilon\in\mathbb{Q}\;
\exists r,s\in\mathbb{Q}\;
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Rational}(q)\land \operatorname{Rational}(\varepsilon)\land \varepsilon>0
\Longrightarrow
\exists r,s\;
\bigl(
...
\begin{remark*}[Negated quantified statement]
\[
\exists q,\varepsilon\in\mathbb{Q}\;
\bigl(\varepsilon>0 \land
\forall r,s\in\mathbb{Q}\;
\neg\bigl(q-\varepsilon < r < q < s < q+\varepsilon\bigr)\bigr).
\]
\end{remark*}

\begin{remark*}[Negation predicate reading]
\[
\exists q,\varepsilon\;\bigl(\operatorname{Rational}(q)\land \operatorname{Rational}(\varepsilon)\land \varepsilon>0 \land
