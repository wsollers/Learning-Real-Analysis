...
\section{Rational Algebra}
\label{sec:rational-algebra}

Once $\mathbb{Q}$ has been recognized as a field, division becomes an
internal operation on nonzero denominators. This gives a clean algebra of
fractions inside $\mathbb{Q}$ itself.
