...
\begin{itemize}
  \item \textbf{Chapter One — Symbolizing Sentences}
  \begin{itemize}
    \item Sentences and sentential connectives
    \item Molecular sentence forms
    \item Symbolization of English sentences
    \item Grouping, parentheses, and elimination of parentheses
  \end{itemize}

  \item \textbf{Chapter Two — Logical Inference}
  \begin{itemize}
    \item 2.2 Rules of inference and proof
    \item 2.3 Sentential derivation
    \item 2.5 Further rules of inference
    \item 2.6 Biconditional sentences
  \end{itemize}

  \item \textbf{Chapter Three — Truth and Validity}
  \begin{itemize}
    \item Truth values and truth-functional connectives
    \item Valid and invalid conclusions
    \item Conditional proof and indirect proof
    \item Consistency
  \end{itemize}

  \item \textbf{Chapter Four — Truth Tables}
  \begin{itemize}
    \item Construction of truth tables
    \item Tautologies
    \item Tautological implication and equivalence
  \end{itemize}

  \item \textbf{Emphasis:}
  \begin{itemize}
    \item Formal symbolization of propositional sentences
    \item Line-by-line sentential proofs
    \item Rules of inference vs truth-table methods
    \item Clear separation of syntax, semantics, and proof
  \end{itemize}

  \item \textbf{Stop here.}  
  Defer Chapters Five and beyond (terms, predicates, quantifiers, identity)
  to the Predicate Logic chapter of the curriculum.
\end{itemize}
\\ \hline
