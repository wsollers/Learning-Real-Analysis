...
\begin{proof}
Suppose $\mathbf{0}$ and $\mathbf{0}'$ are both additive identities in $V$.
Then
\[
...
\[
v + w = \mathbf{0} \qquad \text{and} \qquad v + w' = \mathbf{0}.
\]
Then
\[
...
\begin{proposition}
Let $V$ be a vector space over a field $\mathbb{F}$, let $v \in V$,
and let $\alpha \in \mathbb{F}$. Then:
\begin{enumerate}
...
\begin{proof}
\textbf{(1)} Using distributivity over scalar addition and the additive identity of $\mathbb{F}$,
\[
0_{\mathbb{F}} v = (0_{\mathbb{F}} + 0_{\mathbb{F}}) v = 0_{\mathbb{F}} v + 0_{\mathbb{F}} v.
\]
Adding $-(0_{\mathbb{F}} v)$ to both sides gives
\[
\mathbf{0} = 0_{\mathbb{F}} v,
\]
as required.

\textbf{(2)} Using distributivity over vector addition and the additive identity of $V$,
\[
\alpha \mathbf{0} = \alpha(\mathbf{0} + \mathbf{0}) = \alpha \mathbf{0} + \alpha \mathbf{0}.
\]
Adding $-(\alpha \mathbf{0})$ to both sides gives
\[
\mathbf{0} = \alpha \mathbf{0},
\]
as required.

\textbf{(3)} We show that $(-1_{\mathbb{F}})v$ satisfies the defining property of $-v$,
namely that its sum with $v$ equals $\mathbf{0}$. Using the unit law and part (1),
\[
v + (-1_{\mathbb{F}})v = 1_{\mathbb{F}} v + (-1_{\mathbb{F}}) v
= (1_{\mathbb{F}} + (-1_{\mathbb{F}})) v
= 0_{\mathbb{F}} v
= \mathbf{0}.
\]
By uniqueness of the additive inverse, $(-1_{\mathbb{F}}) v = -v$.
\end{proof}
