...
\end{proposition}
\input{linear-algebra/notes/vector-spaces/proofs/pf-unique-additive-identity}
...
\end{proposition}
\input{linear-algebra/notes/vector-spaces/proofs/pf-unique-additive-inverse}
...
\end{enumerate}
\end{proposition}
\input{linear-algebra/notes/vector-spaces/proofs/pf-scalar-multiplication}