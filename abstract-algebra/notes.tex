...
% Foundations
% -----------------------
\input{abstract-algebra/notes/notes-integers}
\input{abstract-algebra/notes/notes-modular-arithmetic}
\input{abstract-algebra/notes/notes-induction}
\input{abstract-algebra/notes/notes-relations-and-functions}
\input{abstract-algebra/notes/sample-theorem}
\input{abstract-algebra/notes/proof-gcd-linear-combination}
% -----------------------
% Groups
% -----------------------
...
% \input{abstract-algebra/notes/notes-polynomial-rings}
