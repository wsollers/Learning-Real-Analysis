...
\end{proposition}
\input{intro-algebraic-structures/notes/groups/proofs/pf-group-identity-unique}
...
\end{proposition}
\input{intro-algebraic-structures/notes/groups/proofs/pf-group-inverse-unique}
...
\end{enumerate}
\end{proposition}
\input{intro-algebraic-structures/notes/groups/proofs/pf-group-cancellation}
...
\]
\end{proposition}
\input{intro-algebraic-structures/notes/groups/proofs/pf-group-socks-shoes}
