...
\begin{tcolorbox}[title={Definition --- Deleted $\varepsilon$-Neighbourhood}]
...
\begin{tcolorbox}[title={Definition --- Adherent Point}]
...
\begin{tcolorbox}[title={Definition --- Isolated Point}]
...
\begin{remark*}[Negated quantified statement]
\[
  \neg\bigl(X\text{ is closed}\wedgeX\text{ is bounded}\bigr)
  \;\iff\;
