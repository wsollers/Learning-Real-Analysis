...
\[
\begin{aligned}
&a<b\land \operatorname{PartitionOfInterval}(P,[a,b])
\land \operatorname{PartitionOfInterval}(Q,[a,b])\\
&\Longrightarrow
\forall R\;\Bigl(\operatorname{PartitionOfInterval}(R,[a,b])
\Rightarrow
\neg\operatorname{CommonRefinement}(R,P,Q)
\Longleftrightarrow
R \ne P \cup Q\Bigr).
\end{aligned}
\]
