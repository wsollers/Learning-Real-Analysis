\newpage
\phantomsection
\label{prf:discontinuity-equivalence}
...
\begin{itemize}
  \item \hyperref[def:epsilon-delta-discontinuity-at-a-point]{Definition of Epsilon-Delta Discontinuity at a Point}
  ...
  \item Definition of convergence of a sequence
  \item Negation of convergence of a sequence
\end{itemize}
\end{remark*}