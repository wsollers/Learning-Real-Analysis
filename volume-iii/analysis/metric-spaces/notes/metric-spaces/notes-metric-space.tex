...
\end{remark}
\begin{remark}
Most properties of the real absolute value extend to the complex modulus.
However, inequalities involving ordering such as
\[
-|x| \le x \le |x|
\]
do not extend to $\mathbb{C}$ because the complex numbers do not admit
a natural total order compatible with the field structure.
\end{remark}
