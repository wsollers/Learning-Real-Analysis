...
\begin{tikzpicture}[
    ...
    % =====================================================
    \draw[->, grey!60] (-4.5, 2) -- (1.5, 2) node[right, black] {$\mathbb{R}$};
    ...
    % Infimum Annotation
    \draw[<-, thin, grey] (-2.5, 2.1) -- (-2.5, 3.5) node[above] {$\inf(A)$};
    ...
    \begin{scope}[yshift=-2.5cm]
        \draw[->, grey!60] (-1.5, 2) -- (4.5, 2) node[right, black] {$\mathbb{R}$};
        ...
        % Supremum Annotation
        \draw[<-, thin, grey] (2.5, 2.1) -- (2.5, 3.5) node[above] {$\sup(A)$};
