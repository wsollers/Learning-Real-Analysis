...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Limsup Liminf]
...
\begin{tcolorbox}[title=Definition (Tail supremum and infimum)]
...
\begin{tcolorbox}[title=Definition (Limit superior and limit inferior)]
...
\begin{tcolorbox}[title=Example (Strict inequality in subadditivity)]
...
\begin{tcolorbox}[title=Example (Strict inequality in product rule)]
