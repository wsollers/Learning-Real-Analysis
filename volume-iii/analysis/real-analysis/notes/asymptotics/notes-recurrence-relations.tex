...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Recurrence Relations]
...
\begin{tcolorbox}[title=Definition (Recurrence Inequality)]
...
\begin{tcolorbox}[title=Definition (Iterates of a Function)]
...
\begin{tcolorbox}[title=Definition (Multiplicative Recurrence)]
...
\begin{tcolorbox}[title=Definition (Affine Recurrence)]
...
\begin{tcolorbox}[title=Definition (Subsequence Recurrence)]
...
\begin{tcolorbox}[title=Definition (Terminology)]
\begin{itemize}
...
\begin{tcolorbox}[title=Definition (Subadditive Sequence)]
...
\begin{tcolorbox}[title=Definition (Superadditive Sequence)]
...
\begin{tcolorbox}[title=Example (Contraction-Type Recurrence)]
...
\begin{tcolorbox}[title=Example (Contraction Along a Subsequence)]
