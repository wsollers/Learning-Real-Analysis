...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Intervals]
...
\begin{tcolorbox}[title=Definition (Open Interval)]
...
\begin{tcolorbox}[title=Definition (Closed Interval)]
...
\begin{tcolorbox}[title=Definition (Half-Open Intervals)]
...
\begin{tcolorbox}[title=Definition (Open Rays)]
...
\begin{tcolorbox}[title=Definition (Closed Rays)]
...
\begin{tcolorbox}[title=Definition (Degenerate Interval)]
...
\begin{tcolorbox}[title=Definition (Empty Interval)]
If $a>b$, the set
\[
(a,b) = \varnothing
\]
