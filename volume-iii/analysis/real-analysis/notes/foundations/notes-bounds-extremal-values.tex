...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Bounds Extremal Values]
...
\begin{figure}[h]
    \centering
    \input{volume-ii/reals/notes/bounds-figure-01.tex}
...
\begin{tcolorbox}[title=Definition (Upper Bound)]
...
\begin{tcolorbox}[title=Definition (Lower Bound)]
Let $A \subseteq \mathbb{R}$.
...
\begin{tcolorbox}[title=Definition (Bounded Above / Below)]
...
\begin{tcolorbox}[title=Definition (Maximum)]
Let $A \subseteq \mathbb{R}$.
...
\begin{tcolorbox}[title=Definition (Minimum)]
Let $A \subseteq \mathbb{R}$.
...
\begin{tcolorbox}[title=Definition (Supremum (Least Upper Bound))]
...
\begin{tcolorbox}[title=Definition (Infimum (Greatest Lower Bound))]
