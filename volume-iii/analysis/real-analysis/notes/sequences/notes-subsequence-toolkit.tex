...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Subsequence Toolkit]
...
\begin{tcolorbox}[title=Definition (Inherited Property)]
...
\begin{tcolorbox}[title=Definition (Reflected Property)]
...
\begin{tcolorbox}[title=Example (Convergence is Not Reflected)]
...
\begin{tcolorbox}[title=Example (Boundedness is Not Reflected)]
Let $a_n = n$ for $n$ odd and $a_n = 0$ for $n$ even.
The subsequence $(a_{2n}) = (0, 0, 0, \ldots)$ is bounded,
but $(a_n)$ is unbounded.
\end{tcolorbox}

\begin{tcolorbox}[title=Example (Monotonicity is Not Reflected)]
...
\begin{tcolorbox}[title=Definition (Tail Property)]
...
\begin{tcolorbox}[title=Definition (Universal Subsequence Property)]
...
\begin{tcolorbox}[title=Example (Universal Property: Every Subsequence is Cauchy)]
...
\begin{tcolorbox}[title=Example (Universal Property: Every Subsequence Has a Convergent Subsubsequence)]
...
\begin{tcolorbox}[title=Example (Tail Properties)]
...
\begin{tcolorbox}[title=Example (Non-Tail Properties)]
