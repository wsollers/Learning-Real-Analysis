...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Sequence Bounds]
...
\begin{tcolorbox}[title=Definition (Bounded sequence)]
...
\begin{tcolorbox}[title=Definition (Upper bound for a sequence)]
...
\begin{tcolorbox}[title=Definition (Lower bound for a sequence)]
...
\begin{tcolorbox}[title=Definition (Supremum of a sequence)]
...
\begin{tcolorbox}[title=Definition (Infimum of a sequence)]
...
\begin{tcolorbox}[title=Definition (Maximum and minimum of a sequence)]
