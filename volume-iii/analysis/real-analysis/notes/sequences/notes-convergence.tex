...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Convergence]
...
\begin{tcolorbox}[title=Definition (Convergence — informal description)]
...
\begin{tcolorbox}[title=Definition (Convergence — $\varepsilon$ definition)]
...
\begin{tcolorbox}[title=Definition (Neighborhood formulation of convergence in $\mathbb{R}$)]
Let $(x_n)$ be a sequence in $\mathbb{R}$ and let $L\in\mathbb{R}$.
