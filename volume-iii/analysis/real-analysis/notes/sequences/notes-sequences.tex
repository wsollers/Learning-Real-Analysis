...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Sequences]
...
\begin{tcolorbox}[title=Definition (Sequence)]
...
\begin{tcolorbox}[title=Definition (Subsequence)]
...
\begin{tcolorbox}[title=Example (Constant sequence)]
...
\begin{tcolorbox}[title=Example (Arithmetic sequence)]
...
\begin{tcolorbox}[title=Example (Geometric sequence)]
...
\begin{tcolorbox}[title=Example (Harmonic sequence)]
\[
x_n := \frac{1}{n}.
\]
...
\begin{tcolorbox}[title=Example (Alternating sequence)]
\[
x_n := (-1)^n.
\]
...
\begin{tcolorbox}[title=Example (Polynomial growth sequence)]
...
\begin{tcolorbox}[title=Example (Exponential decay sequence)]
\[
x_n := \frac{1}{2^n}.
\]
