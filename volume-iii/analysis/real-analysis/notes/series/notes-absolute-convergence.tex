...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Absolute Convergence]
...
\begin{tcolorbox}[title=Definition (Absolute convergence)]
A series
\[
\sum_{n=1}^{\infty} a_n
\]
...
\begin{tcolorbox}[title=Definition (Conditional convergence)]
A series
\[
\sum_{n=1}^{\infty} a_n
\]
...
\begin{tcolorbox}[title=Example (Geometric series)]
For $|r|<1$,
\[
\sum_{n=0}^{\infty} r^n
\]
...
\begin{tcolorbox}[title=Example (Alternating harmonic series)]
\[
