...
% Toolkit
% ---------------------------------------------------------
\begin{tcolorbox}[title=Toolkit: Power Series]
...
\begin{tcolorbox}[title=Definition (Power series)]
...
\begin{tcolorbox}[title=Definition (Radius of convergence)]
...
\begin{tcolorbox}[title=Definition (Interval of convergence)]
