...
\subsection{The Function \(2^n\) in Discrete Calculus}
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  ...
  fonttitle=\small\bfseries, label=prop:delta-two-n]
\[
\Delta\, 2^n = 2^n.
\]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=propbox, colframe=propborder, arc=2pt,
  ...
  fonttitle=\small\bfseries, label=prop:antideriv-two-n]
...
\subsection*{Higher Differences of \(2^n\)}
...
\subsection*{\(2^n\) in Combinatorics and the Newton Expansion}
