...
and power set.
Set algebras ask: which collections of sets are closed under these
operations, and what algebraic laws govern them?

\medskip
\noindent\textbf{What this chapter builds.}
We study Boolean algebras of sets, characteristic functions as bridges
between sets and arithmetic, and the $\sigma$-algebras that underlie
measure theory. Power set algebras and field algebras of sets are
the main examples.

\medskip
\noindent\textbf{Where this leads.}
Measure theory requires a $\sigma$-algebra as its foundation.
The Boolean algebra structure connects to propositional logic.
Characteristic functions reappear as simple functions in integration theory.
\end{tcolorbox}
\vspace{1em}
...
% \input{volume-iii/algebra/set-algebras/notes-finite-structures}
% \input{volume-iii/algebra/set-algebras/notes-boolean-algebras}
% \input{volume-iii/algebra/set-algebras/notes-sigma-structures}
% \input{volume-iii/algebra/set-algebras/notes-generated-systems}
% \input{volume-iii/algebra/set-algebras/notes-auxiliary-systems}
% \input{volume-iii/algebra/set-algebras/notes-applications}
