...
\]
\end{proposition}
\input{volume-iii/algebra/algebraic-structures/notes/rings/proofs/pf-ring-mult-zero}
...
\end{proposition}
\input{volume-iii/algebra/algebraic-structures/notes/rings/proofs/pf-ring-mult-neg}
